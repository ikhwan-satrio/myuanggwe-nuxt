...
import { t as cn, x as reactiveOmit } from './server.mjs';
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<td${ssrRenderAttrs(mergeProps({
        ...
        class: unref(cn)("p-3 align-middle whitespace-nowrap [&:has([role=checkbox])]:pr-0", props.class)
      }, _attrs))}>`);
      ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
      _push(`</td>`);
    };
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<th${ssrRenderAttrs(mergeProps({
        ...
        class: unref(cn)("text-muted-foreground h-12 px-3 text-left align-middle text-xs font-medium uppercase tracking-wider whitespace-nowrap [&:has([role=checkbox])]:pr-0", props.class)
      }, _attrs))}>`);
      ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
      _push(`</th>`);
    };
...
export { _sfc_main as _, _sfc_main$1 as a, _sfc_main$4 as b, _sfc_main$5 as c, _sfc_main$7 as d, _sfc_main$8 as e };
//# sourceMappingURL=TableHeader-CtjPTqbx.mjs.map
